...
commander
    ...
    .action(utils_1.handleError(commands_1.login));
/**
...
commander
    .command('logout')
    .description('Log out')
    .action(utils_1.handleError(commands_1.logout));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.create));
/**
...
commander
    ...
    .option('--rootDir <rootDir>', 'Local root directory in which clasp will store your project files.')
    .action(utils_1.handleError(commands_1.clone));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.pull));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.push));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.status));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.openCmd));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.deployments));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.deploy));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.undeploy));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.version));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.versions));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.list));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.logs));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.run));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.apis));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.help));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.setting));
/**
...
commander
    ...
    .action(utils_1.handleError(commands_1.defaultCmd));
/**
