...
(0, _ava.default)('_isNaN should return false', t => {
  var _rec = new _powerAssertRecorder();

  t.false(_rec._expr(_rec._capt(_rec._capt(Number, "arguments/0/callee/object")._isNaN(5), "arguments/0"), {
    content: "t.false(Number._isNaN(5))",
    filepath: "test/number-test.js",
    line: 6,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"false\",\"range\":[2,7]},\"computed\":false,\"range\":[0,7]},\"arguments\":[{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"Number\",\"range\":[8,14]},\"property\":{\"type\":\"Identifier\",\"name\":\"_isNaN\",\"range\":[15,21]},\"computed\":false,\"range\":[8,21]},\"arguments\":[{\"type\":\"NumericLiteral\",\"value\":5,\"range\":[22,23]}],\"range\":[8,24]}],\"range\":[0,25]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"false\"},\"value\":\"false\",\"range\":[2,7]},{\"type\":{\"label\":\"(\"},\"range\":[7,8]},{\"type\":{\"label\":\"name\"},\"value\":\"Number\",\"range\":[8,14]},{\"type\":{\"label\":\".\"},\"range\":[14,15]},{\"type\":{\"label\":\"name\"},\"value\":\"_isNaN\",\"range\":[15,21]},{\"type\":{\"label\":\"(\"},\"range\":[21,22]},{\"type\":{\"label\":\"num\"},\"value\":5,\"range\":[22,23]},{\"type\":{\"label\":\")\"},\"range\":[23,24]},{\"type\":{\"label\":\")\"},\"range\":[24,25]}]",
    visitorKeys: _powerAssertVisitorKeys
  }));
});
(0, _ava.default)('_isNaN should return true', t => {
  var _rec2 = new _powerAssertRecorder();

  t.true(_rec2._expr(_rec2._capt(_rec2._capt(Number, "arguments/0/callee/object")._isNaN(_rec2._capt(NaN, "arguments/0/arguments/0")), "arguments/0"), {
    content: "t.true(Number._isNaN(NaN))",
    filepath: "test/number-test.js",
    line: 10,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"Number\",\"range\":[7,13]},\"property\":{\"type\":\"Identifier\",\"name\":\"_isNaN\",\"range\":[14,20]},\"computed\":false,\"range\":[7,20]},\"arguments\":[{\"type\":\"Identifier\",\"name\":\"NaN\",\"range\":[21,24]}],\"range\":[7,25]}],\"range\":[0,26]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"Number\",\"range\":[7,13]},{\"type\":{\"label\":\".\"},\"range\":[13,14]},{\"type\":{\"label\":\"name\"},\"value\":\"_isNaN\",\"range\":[14,20]},{\"type\":{\"label\":\"(\"},\"range\":[20,21]},{\"type\":{\"label\":\"name\"},\"value\":\"NaN\",\"range\":[21,24]},{\"type\":{\"label\":\")\"},\"range\":[24,25]},{\"type\":{\"label\":\")\"},\"range\":[25,26]}]",
    visitorKeys: _powerAssertVisitorKeys
  }));
});
(0, _ava.default)('_round should round down to nearest hundred', t => {
  t.is(Number._round(5540, 2), 550);
});
(0, _ava.default)('_round should round up to nearest hundred', t => {
  t.is(Number._round(5550, 2), 560);
});
(0, _ava.default)('_round should round down to nearest hundredth', t => {
  t.is(Number._round(.554, -2), .55);
});
(0, _ava.default)('_round should round up to nearest hundredth', t => {
  t.is(Number._round(.555, -2), .56);
});
//# sourceMappingURL=/Users/nyap/tasks/science-grading/node_modules/.cache/ava/4ad5d4485e1193247c53ad674b6cdf56.js.map