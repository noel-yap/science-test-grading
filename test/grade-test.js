...
test('_grade should give full credit', t => {
  ...
  const observed = Grade._grade(false, gradingProperties, 16, '100. kPa', '100.*10^6 g*m^-1*s^-2');
...
test('_grade should give partial credit for missing magnitude', t => {
  ...
  const observed = Grade._grade(false, gradingProperties, 16, 'kPa', '100.*10^6 g*m^-1*s^-2');
...
test('_grade should give partial credit for incorrect magnitude', t => {
  ...
  const observed = Grade._grade(false, gradingProperties, 16, '100.Pa', '100.*10^6 g*m^-1*s^-2');
...
test('_grade should give partial credit for too few significant figures', t => {
  ...
  const observed = Grade._grade(false, gradingProperties, 16, '100kPa', '100.*10^6 g*m^-1*s^-2');
...
test('_grade should give partial credit for too many significant figures', t => {
  ...
  const observed = Grade._grade(false, gradingProperties, 16, '100.000kPa', '100.*10^6 g*m^-1*s^-2');
...
test('_grade should give partial credit for close answers', t => {
  ...
  const observed = Grade._grade(false, gradingProperties, 16, '99.1kPa', '100.*10^6 g*m^-1*s^-2');
...
test('_grade should give partial credit for not-so-close answers', t => {
  ...
  const observed = Grade._grade(false, gradingProperties, 16, '90.0kPa', '100.*10^6 g*m^-1*s^-2');
...
test('_grade should give partial credit for missing units', t => {
  ...
  const observed = Grade._grade(false, gradingProperties, 16, '100.*10^6', '100.*10^6 g*m^-1*s^-2');
...
test('_grade should give partial credit for incorrect units', t => {
  ...
  const observed = Grade._grade(false, gradingProperties, 16, '100. kN', '100.*10^6 g*m^-1*s^-2');

  t.deepEqual(observed, [13, 'Incorrect units.']);
});

test('_grade should give no credit for no answer', t => {
  const gradingProperties = {
    'missing-magnitude': .25,
    'missing-units': .75
  };
  const observed = Grade._grade(false, gradingProperties, 16, '', '999ppm');

  t.deepEqual(observed, [0, '']);
});
