...
test('_parseLiteral should parse multi-character string', t => {
  const observed = SIParser.SIParser._parseLiteral('snth', 'sn');
...
test('_parseLiteral should parse null string', t => {
  const observed = SIParser.SIParser._parseLiteral('snth', '');
...
test('_parseDecimal should succeed with plus followed by decimal', t => {
  const observed = new SIParser.SIParser()._parseDecimal('+1234.5678');
...
test('_parseDecimal should succeed with digits but no dot', t => {
  const observed = new SIParser.SIParser()._parseDecimal('1234aoeu');
...
test('_parseDecimal should succeed with just dot digits', t => {
  const observed = new SIParser.SIParser()._parseDecimal('.1234');
...
test('_parseDecimal should succeed with digits dot', t => {
  const observed = new SIParser.SIParser()._parseDecimal('1234.aoeu');

  t.deepEqual(observed, new SIParser.SuccessResult('1234.', 'aoeu', 1234, observed.previousResult).withName(observed.name));
});

test('_parseExponent should fail', t => {
  const observed = new SIParser.SIParser()._parseExponent('aoeu');

  t.deepEqual(observed, new SIParser.FailureResult('', 'aoeu').withName(observed.name));
});

test('_parseInteger should fail with plus but no integer', t => {
  const observed = new SIParser.SIParser()._parseInteger('+aoeu');

  t.deepEqual(observed, new SIParser.FailureResult('+', 'aoeu', '+', observed.previousResult).withName(observed.name));
});

test('_parseInteger should succeed with plus followed by integer', t => {
  const observed = new SIParser.SIParser()._parseInteger('+1234');
...
test('_parseInteger should fail with empty string', t => {
  const observed = new SIParser.SIParser()._parseInteger((''));

  t.deepEqual(observed, new SIParser.FailureResult('', '').withName(observed.name));
});

test('_parseBase should parse grams', t => {
  const observed = new SIParser.SIParser()._parseBase('g');
...
test('_parseBase should parse meters', t => {
  const observed = new SIParser.SIParser()._parseBase('m');
...
test('_parseBase should parse seconds', t => {
  const observed = new SIParser.SIParser()._parseBase('s');
...
test('_parseBase should parse Kelvins', t => {
  const observed = new SIParser.SIParser()._parseBase('K');
...
test('_parseBase should parse moles', t => {
  const observed = new SIParser.SIParser()._parseBase('mol');
...
test('_parseBase should parse amperes', t => {
  const observed = new SIParser.SIParser()._parseBase('A');
...
test('_parseBase should parse candelas', t => {
  const observed = new SIParser.SIParser()._parseBase('cd');
...
test('_parseBase should parse Newtons', t => {
  const observed = new SIParser.SIParser()._parseBase('N');
...
test('_parseBase should parse Pascals', t => {
  const observed = new SIParser.SIParser()._parseBase('Pa');
...
test('_parseBase should parse Joulse', t => {
  const observed = new SIParser.SIParser()._parseBase('J');
...
test('_parseBase should parse Watts', t => {
  const observed = new SIParser.SIParser()._parseBase('W');
...
test('_parseBase should parse percent', t => {
  const observed = new SIParser.SIParser()._parseBase('%');
...
test('_parseBase should parse parts-per-million', t => {
  const observed = new SIParser.SIParser()._parseBase('ppm');
...
test('_parseBase should parse parts-per-billion', t => {
  const observed = new SIParser.SIParser()._parseBase('ppb');
...
test('_parseBase should parse parts-per-trillion', t => {
  const observed = new SIParser.SIParser()._parseBase('ppt');
...
test('_parseBase should parse parts-per-quadrillion', t => {
  const observed = new SIParser.SIParser()._parseBase('ppq');
...
test('_parseBase should parse Celcius', t => {
  const observed = new SIParser.SIParser()._parseBase('°C');
...
test('_parseBase should parse yotta', t => {
  const observed = new SIParser.SIParser()._parseBase('Ym');
...
test('_parseBase should parse zetta', t => {
  const observed = new SIParser.SIParser()._parseBase('Zm');
...
test('_parseBase should parse exa', t => {
  const observed = new SIParser.SIParser()._parseBase('Em');
...
test('_parseBase should parse peta', t => {
  const observed = new SIParser.SIParser()._parseBase('Pm');
...
test('_parseBase should parse tera', t => {
  const observed = new SIParser.SIParser()._parseBase('Tm');
...
test('_parseBase should parse giga', t => {
  const observed = new SIParser.SIParser()._parseBase('Gm');
...
test('_parseBase should parse mega', t => {
  const observed = new SIParser.SIParser()._parseBase('Mm');
...
test('_parseBase should parse kilo', t => {
  const observed = new SIParser.SIParser()._parseBase('km');
...
test('_parseBase should parse hecto', t => {
  const observed = new SIParser.SIParser()._parseBase('hm');
...
test('_parseBase should parse deca', t => {
  const observed = new SIParser.SIParser()._parseBase('dam');
...
test('_parseBase should parse deci', t => {
  const observed = new SIParser.SIParser()._parseBase('dm');
...
test('_parseBase should parse centi', t => {
  const observed = new SIParser.SIParser()._parseBase('cm');
...
test('_parseBase should parse micro', t => {
  const observed = new SIParser.SIParser()._parseBase('μm');
...
test('_parseBase should parse nano', t => {
  const observed = new SIParser.SIParser()._parseBase('nm');
...
test('_parseBase should parse femto', t => {
  const observed = new SIParser.SIParser()._parseBase('fm');
...
test('_parseBase should parse atto', t => {
  const observed = new SIParser.SIParser()._parseBase('am');
...
test('_parseBase should fail with prefix with °C', t => {
  const observed = new SIParser.SIParser()._parseBase('k°C');
...
test('_parseFactor should succeed with just base', t => {
  const observed = new SIParser.SIParser()._parseFactor('s');
...
test('_parseFactor should succeed with both base and exponent', t => {
  const observed = new SIParser.SIParser()._parseFactor('s^-2');
...
test('_parseFactor should not have -0 exponents', t => {
  const observed = new SIParser.SIParser()._parseFactor('mol^-1');
...
test('_parseTerm should parse factor times factor', t => {
  const observed = new SIParser.SIParser()._parseTerm('g*m');
...
test('_parseTerm should parse factor divided by factor', t => {
  const observed = new SIParser.SIParser()._parseTerm('m/s');
...
test('_parseTerm should parse consecutive multiplication operators', t => {
  const observed = new SIParser.SIParser()._parseTerm('g*m*s');
...
test('_parseTerm should fail with failed multiplier', t => {
  const observed = new SIParser.SIParser()._parseTerm('%*1ppm');
...
test('_parseUnits should fail with nothing after open parenthesis', t => {
  const observed = new SIParser.SIParser()._parseUnits('(');
...
test('_parseUnits should fail with unbalanced parentheses', t => {
  const observed = new SIParser.SIParser()._parseUnits('(A');
...
test('_parseUnits should parse factor only', t => {
  const observed = new SIParser.SIParser()._parseUnits('K');
...
test('_parseMagnitude should succeed wth significand only', t => {
  const observed = new SIParser.SIParser()._parseMagnitude('234.567');
...
test('_parseMagnitude should fail with nothing after *10^', t => {
  const observed = new SIParser.SIParser()._parseMagnitude('234.567*10^');
...
test('_parseMagnitude parse *10^ syntax', t => {
  const observed = new SIParser.SIParser()._parseMagnitude('234.567*10^89');
...
test('_parseMagnitude should fail with nothing after E', t => {
  const observed = new SIParser.SIParser()._parseMagnitude('234.567E');
...
test('_parseMagnitude parse E syntax', t => {
  const observed = new SIParser.SIParser()._parseMagnitude('234.567E89');
...
test('_parseMagnitude should fail', t => {
  const observed = new SIParser.SIParser()._parseMagnitude('aoeu');
...
test('_parseExpression should parse magnitude only', t => {
  const observed = new SIParser.SIParser()._parseExpression('6.02214086*10^23');
...
test('_parseExpression should parse magnitude with term', t => {
  const observed = new SIParser.SIParser()._parseExpression('6.02214086*10^23mol^-1');
...
test('_parseExpression should parse magnitude times term', t => {
  const observed = new SIParser.SIParser()._parseExpression('6.02214086*10^23*mol^-1');
...
test('_parseExpression should parse magnitude divided by term', t => {
  const observed = new SIParser.SIParser()._parseExpression('6.02214086*10^23/mol');
...
test('_parseExpression should parse units only', t => {
  const observed = new SIParser.SIParser()._parseExpression('mol^-1');
...
test('_parseExpression should fail', t => {
  const observed = new SIParser.SIParser()._parseExpression('aoeu');

  t.deepEqual(observed, new SIParser.FailureResult('', 'aoeu').withName(observed.name));
});

test('_parseExpression should fail with prefix with °C', t => {
  const observed = new SIParser.SIParser()._parseExpression('1001k°C');

  t.deepEqual(observed, new SIParser.FailureResult('1001', '1001k°C').withName(observed.name));
});

test('_parseExpression should do conversion', t => {
  const observed = new SIParser.SIParser()._parseExpression('0°C');
...
test('_normalizeUnits should throw on non-string input', t => {
  t.throws(() => {
    new SIParser.SIParser()._normalizeUnits(1);
  }, Error);
});

test('_normalizeUnits should parse empty string', t => {
  const observed = new SIParser.SIParser()._normalizeUnits('');
...
test('_normalizeUnits should normalize units', t => {
  const observed = new SIParser.SIParser()._normalizeUnits('100kPa');
...
test('_normalizeUnits should fail', t => {
  const observed = new SIParser.SIParser()._normalizeUnits('aoeu');
